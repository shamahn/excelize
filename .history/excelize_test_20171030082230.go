...
func TestSetCellHyperLink(t *testing.T) {
	...
	xlsx.SetCellHyperLink("Sheet1", "B19", "https://github.com/shamahn/excelize", "External")
	// Test add first hyperlink in a work sheet.
	xlsx.SetCellHyperLink("Sheet2", "C1", "https://github.com/shamahn/excelize", "External")
...
func TestMergeCell(t *testing.T) {
	...
	xlsx.SetCellHyperLink("Sheet1", "J11", "https://github.com/shamahn/excelize", "External")
